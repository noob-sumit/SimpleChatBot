...
// function for message recieved from the server--------------------------
...
function fetchmsg(){
     ...
     var url = 'http://localhost:5000/send-msg';
      ...
      console.log("abc",data)
        fetch(url, {
          method: 'POST', // my message is being posted to the dailogflow server
          body:data
        }).then(res => res.json())
         .then(response => {
          console.log(response);
          serverMessage(response.Reply);  // i'm getting response from the dialogflow server
//-----------speakout function---=--=-=-=-=-===-=-=-=--------------------=====================--
